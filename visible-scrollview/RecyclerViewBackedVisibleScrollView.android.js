 ...
 *
 * @providesModule RecyclerViewBackedVisibleVisibleScrollView
 */
'use strict';

var React = require('React');
var ScrollResponder = require('ScrollResponder');
var VisibleScrollView = require('VisibleScrollView');
 ...
 * similarly to how `VisibleScrollView` is doing it. Thanks to the fact that it uses
 ...
 * `removeClippedSubviews = true` on a `VisibleScrollView.js`).
 *
 ...
 *       renderScrollComponent={props => <RecyclerViewBackedVisibleScrollView {...props} />}
 *     />
 *   );
 * },
 * ```
 */
var RecyclerViewBackedVisibleScrollView = React.createClass({

  propTypes: {
    ...VisibleScrollView.propTypes,
  },
...
var NativeAndroidRecyclerView = requireNativeComponent(
  'AndroidRecyclerViewBackedVisibleScrollView',
  RecyclerViewBackedVisibleScrollView
);

module.exports = RecyclerViewBackedVisibleScrollView;
